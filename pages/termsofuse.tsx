const termofuse = () => {
  return (
    <div>
      ...
      <p>Welcome to simpletodo.org!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of SimpleTodo&apos;s Website, located at https://simpletodo.org.
      </p>
      <p>
        By accessing this website, we assume you accept these terms and
        conditions. Do not continue to use simpletodo.org if you do not agree to
        take all of the terms and conditions stated on this page.
      </p>
      <h4>Cookies:</h4>
      <p>
        The website uses cookies to help personalize your online experience. By
        accessing simpletodo.org, you agreed to use the required cookies.
      </p>
      <p>
      ...
      <h4>License:</h4>
      <p>
        Unless otherwise stated, SimpleTodo and/or its licensors own the
        intellectual property rights for all material on simpletodo.org. All
        intellectual property rights are reserved. You may access this from
        simpletodo.org for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Copy or republish material from simpletodo.org</li>
        <li>Sell, rent, or sub-license material from simpletodo.org</li>
        <li>Reproduce, duplicate or copy material from simpletodo.org</li>
        <li>Redistribute content from simpletodo.org</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer users an opportunity to post and exchange
        opinions and information in certain areas of the website. SimpleTodo
        ...
        SimpleTodo, its agents, and/or affiliates. Comments reflect the views
        and opinions of the person who posts their views and opinions. To the
        extent permitted by applicable laws, SimpleTodo shall not be liable for
      ...
      <p>
        SimpleTodo reserves the right to monitor all Comments and remove any
      ...
      <p>
        You hereby grant SimpleTodo a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of SimpleTodo; and (d) the link is
      ...
      <p>
        ...
        e-mail to SimpleTodo. Please include your name, your organization name,
      ...
      <p>
        No use of SimpleTodo&apos;s logo or other artwork will be allowed for
